...
export default function EmailVerification() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await api.post('/onboarding/verify-email', { otp })
  ...
  const handleResend = async () => {
    ...
    setError('')
    try {
      await api.post('/onboarding/resend-otp', { type: 'email' })
      setTimer(60)
      setOtp('')
    } catch (err) {
    ...
    <div className="onboarding-container">
      <div className="onboarding-card">
        ...
        <div className="onboarding-progress">
          ...
          <div className="progress-step active">2. Email</div>
