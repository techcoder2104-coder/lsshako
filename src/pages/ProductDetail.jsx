      ...
      <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="bg-white rounded-lg overflow-hidden border-2 border-gray-200 shadow-lg">
              <div className="aspect-square bg-gray-100 relative overflow-hidden">
                <img
                  ...
                  style={{
                    transform: `scale(2) translate(calc(${50 - zoomPosition.x}% / 2), calc(${50 - zoomPosition.y}% / 2))`,
                    transformOrigin: `${zoomPosition.x}% ${zoomPosition.y}%`,
                  }}
                />
              </div>
              <div className="bg-gray-50 px-4 py-3 text-center text-xs text-gray-600 font-medium">
                Hover to zoom
              </div>
            </div>
          </div>
        ...
        <div className="md:col-span-1 space-y-4 sm:space-y-6">
          ...
          <div className="pb-4 sm:pb-6 border-b border-gray-200">
            <p
              className={`font-semibold text-sm sm:text-base ${inStock ? "text-green-600" : "text-red-600"}`}
            >
              {inStock
            ...
            <div>
              ...
              <div className="space-y-3 bg-white p-4 sm:p-6 rounded-lg border border-gray-200">
                {Object.entries(product.specifications).map(([key, value]) => (
                  <div
                    key={key}
                    className="flex justify-between pb-3 border-b border-gray-100 last:border-b-0"
                  >
